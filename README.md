...
See the [documentation](https://github.com/MorpheApp/morphe-documentation#readme) to learn how to apply patches and build RVX Morphed apps.

Report issues [here](https://github.com/wchill/rvx-morphed).
