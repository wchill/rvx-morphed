...
public class SearchHistoryManager {
    ...
    private static final int ID_HISTORY_TEXT = getIdIdentifier(
            "history_text");
    private static final int ID_DELETE_ICON = getIdIdentifier(
            "delete_icon");
    private static final int ID_EMPTY_HISTORY_TITLE = getIdIdentifier(
            "empty_history_title");
    private static final int ID_EMPTY_HISTORY_SUMMARY = getIdIdentifier(
