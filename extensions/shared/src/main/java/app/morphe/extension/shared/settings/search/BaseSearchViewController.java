...
public abstract class BaseSearchViewController {
    ...
    private void initializeOverlayContainer() {
        ...
        overlayContainer.setBackgroundColor(BaseThemeUtils.getAppBackgroundColor());
    ...
    public static int getSearchViewBackground() {
        return BaseThemeUtils.adjustColorBrightness(
                BaseThemeUtils.getDialogBackgroundColor(),
                BaseThemeUtils.isDarkModeEnabled() ? 1.11f : 0.95f
        );
    }
