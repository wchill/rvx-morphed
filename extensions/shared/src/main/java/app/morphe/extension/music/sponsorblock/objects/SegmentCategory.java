...
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_FILLER;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_HOOK;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_HOOK_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_INTERACTION;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_INTRO;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_OUTRO;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_PREVIEW;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_SPONSOR;
import static app.morphe.extension.music.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
