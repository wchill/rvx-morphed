...
import static app.morphe.extension.youtube.shared.RootView.isAdProgressTextVisible;
import static app.morphe.extension.youtube.utils.VideoUtils.getFormattedTimeStamp;
...
public class SegmentPlaybackController {
     ...
     */
    static void executeDownloadSegments(String newlyLoadedVideoId) {
