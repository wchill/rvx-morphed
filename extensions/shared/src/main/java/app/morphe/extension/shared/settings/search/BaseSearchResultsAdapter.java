...
public abstract class BaseSearchResultsAdapter extends ArrayAdapter<BaseSearchResultItem> {
    ...
    protected static final int ID_PREFERENCE_TITLE = getIdIdentifier(
            "preference_title");
    protected static final int ID_PREFERENCE_SUMMARY = getIdIdentifier(
            "preference_summary");
    protected static final int ID_PREFERENCE_PATH = getIdIdentifier(
            "preference_path");
    protected static final int ID_PREFERENCE_SWITCH = getIdIdentifier(
            "preference_switch");
    ...
    protected void setupPreferenceView(View view, TextView titleView, TextView summaryView, Preference preference,
        ...
        if (BaseThemeUtils.isDarkModeEnabled()) {
    ...
    protected void blinkView(View view) {
        ...
        int startColor = BaseThemeUtils.getAppBackgroundColor();
        int highlightColor = BaseThemeUtils.adjustColorBrightness(
                startColor,
                BaseThemeUtils.isDarkModeEnabled() ? 1.25f : 0.8f
        );
