...
public class SheetBottomDialog {
    ...
    public static DraggableLinearLayout createMainLayout(@NonNull Context context, @Nullable Integer backgroundColor) {
        ...
        int color = (backgroundColor != null) ? backgroundColor : BaseThemeUtils.getDialogBackgroundColor();
        ...
        handleBackground.getPaint().setColor(BaseThemeUtils.adjustColorBrightness(color, 0.9f, 1.25f));
