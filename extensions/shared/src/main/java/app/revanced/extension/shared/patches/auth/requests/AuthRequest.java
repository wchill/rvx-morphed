...
import static app.revanced.extension.shared.patches.auth.requests.AuthRoutes.createAccessTokenBody;
...
public class AuthRequest {
    ...
    private static JSONObject fetchUrl(RequestType requestType, @Nullable String token) {
        ...
        try {
            ...
            switch (requestType) {
                case GET_ACTIVATION_CODE -> body = createActivationCodeBody();
