...
public class SponsorBlockPreferenceGroup extends PreferenceGroup {
    private static final int preferencesCategoryLayout =
            getLayoutIdentifier("revanced_settings_preferences_category");
    ...
    protected void onAttachedToActivity() {
        try {
            ...
            appearanceCategory.setLayoutResource(preferencesCategoryLayout);
            ...
            createSegmentCategory.setLayoutResource(preferencesCategoryLayout);
            ...
            generalCategory.setLayoutResource(preferencesCategoryLayout);
