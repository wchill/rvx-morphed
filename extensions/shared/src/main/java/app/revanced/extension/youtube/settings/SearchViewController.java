...
public class SearchViewController {
    ...
    public static int getSearchViewBackground() {
        return ThemeUtils.isDarkModeEnabled()
                ? ThemeUtils.adjustColorBrightness(ThemeUtils.getDialogBackgroundColor(), 1.11f)
                : ThemeUtils.adjustColorBrightness(ThemeUtils.getThemeLightColor(), 0.95f);
    }
    ...
    private SearchViewController(Activity activity, Toolbar toolbar, ReVancedPreferenceFragment fragment) {
        ...
        searchView = activity.findViewById(getIdIdentifier("revanced_search_view"));
        searchContainer = activity.findViewById(getIdIdentifier("revanced_search_view_container"));
    ...
    private void openSearch() {
        isSearchActive = true;
        toolbar.getMenu().findItem(getIdIdentifier("action_search")).setVisible(false);
        toolbar.setTitle("");
    ...
    public void closeSearch() {
        ...
        toolbar.getMenu().findItem(getIdIdentifier("action_search")).setVisible(true);
    ...
    private class SearchHistoryAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, @NonNull android.view.ViewGroup parent) {
            if (convertView == null) {
                convertView = LinearLayout.inflate(getContext(), getLayoutIdentifier("revanced_search_suggestion_item"), null);
            }
            ...
            // Set query text.
            TextView textView = convertView.findViewById(getIdIdentifier("suggestion_text"));
            if (textView != null) {
