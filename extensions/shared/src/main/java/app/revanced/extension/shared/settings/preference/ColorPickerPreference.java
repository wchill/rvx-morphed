...
public class ColorPickerPreference extends EditTextPreference {
    ...
    private void init() {
        ...
        setWidgetLayoutResource(ResourceUtils.getLayoutIdentifier("revanced_color_dot_widget"));
    }
    ...
    protected void onBindView(View view) {
        ...
        widgetColorDot = view.findViewById(
                ResourceUtils.getIdIdentifier("revanced_color_dot_widget")
        );
        widgetColorDot.setBackgroundResource(
                ResourceUtils.getDrawableIdentifier("revanced_settings_circle_background")
        );
    ...
    protected void showDialog(Bundle state) {
        ...
        Pair<Dialog, LinearLayout> dialogPair = Utils.createCustomDialog(
                context,
                getTitle() != null ? getTitle().toString() : str("revanced_extended_settings_color_picker"), // Title.
                null, // No message.
                null, // No EditText.
                null, // OK button text.
                () -> {
