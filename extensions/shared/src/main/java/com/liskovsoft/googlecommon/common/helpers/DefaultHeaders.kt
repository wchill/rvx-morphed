...
object DefaultHeaders {
    ...
    private const val ACCEPT_ENCODING_COMPRESSED =
        "gzip, deflate, br" // NOTE: HttpUrlConnection won't work with compression
    ...
    private const val USER_AGENT_SAMSUNG_2 =
    ...
    private const val USER_AGENT_COBALT_1 =
        "Mozilla/5.0 (DirectFB; Linux x86_64) Cobalt/4.13031-qa (unlike Gecko) Starboard/1"
    private const val USER_AGENT_COBALT_2 =
        "Mozilla/5.0 (DirectFB; Linux x86_64) Cobalt/20.lts.2.0-gold (unlike Gecko) Starboard/11"

    // See: https://github.com/youtube/cobalt/blob/main/cobalt/browser/user_agent/user_agent_platform_info.cc#L506
    private const val USER_AGENT_COBALT_3 =
    ...
    private const val USER_AGENT_MOBILE_CHROME_1 =
        "Mozilla/5.0 (Linux; Android 7.1.2; Redmi 4A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.86 Mobile Safari/537.36"
    private const val USER_AGENT_MOBILE_CHROME_2 =
        "Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36"
    private const val USER_AGENT_MOBILE_FIREFOX =
        "Mozilla/5.0 (Android 16; Mobile; rv:140.0) Gecko/140.0 Firefox/140.0"
    private const val USER_AGENT_PS_VITA =
    ...
    private const val USER_AGENT_ANDROID_1 =
        "com.google.android.youtube/19.26.42(Linux; U; Android 13; en_US; Pixel 4a Build/TQ3A.230805.001.S2) gzip"
    private const val USER_AGENT_IOS_1 =
        "com.google.ios.youtube/17.33.2 (iPhone14,3; U; CPU iOS 15_6 like Mac OS X)"
    private const val USER_AGENT_IOS_2 =
        "com.google.ios.youtube/19.29.1 (iPhone16,2; U; CPU iOS 17_5_1 like Mac OS X;)"
    const val USER_AGENT_SAFARI =
